...
public static class EmailTemplate
{
 public static string Render(JsonNode r, JsonNode s, string eventStatus, string audience, string destination)
 {
  ...
  var next=eventStatus switch {
   ...
   "pendiente_pago"=>"Completa la transferencia indicada y sube tu comprobante y registra la referencia en tu seguimiento. El despacho verificará el ingreso antes de agendar.",
